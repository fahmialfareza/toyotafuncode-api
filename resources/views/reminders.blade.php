...
<div class="container" style="margin-top: 50px;">
    ...
    <h4 class="text-center">Reminder</h4><br>
    <h5># Reminder</h5>
        ...
        <div class="modal-dialog modal-dialog-centered" style="width:55%;">
            <div class="modal-content" style="overflow: hidden;">
                <div class="modal-header">
                    <h4 class="modal-title" id="custom-width-modalLabel">Tambah Reminder</h4>
        ...
        $.each(value, function (index, value) {
            if (value) {
                htmls.push('<tr>\
              		...
              		<td><a href="/reminders/'+ index +'" class="btn btn-info updateData" data-id="' + index + '">Lihat Reminder</a>\
              	</tr>');
            }
            lastIndex = index;
        });
