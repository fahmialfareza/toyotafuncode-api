...
<div class="container" style="margin-top: 50px;">
    ...
    <h4 class="text-center">Teknisi</h4><br>

    <h5># Tambah Teknisi</h5>
...
<script>
    ...
    $('#submitCustomer').on('click', function () {
        ...
        firebase.database().ref('engineers/' + userID).set({
            name: name,
        });
    ...
    $('body').on('click', '.updateData', function () {
        ...
        firebase.database().ref('engineers/' + updateID).on('value', function (snapshot) {
    ...
    $('.updateCustomer').on('click', function () {
        ...
        var updates = {};
        updates['/engineers/' + updateID] = postData;
    ...
    $('.deleteRecord').on('click', function () {
        ...
        firebase.database().ref('engineers/' + id).remove();
