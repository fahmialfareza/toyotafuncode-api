...
<div class="container" style="margin-top: 50px;">
    ...
    <h4 class="text-center">Komponen</h4><br>
...
<script>
    ...
    // Get Data
    firebase.database().ref('components/').on('value', function (snapshot) {
    ...
    $('#submitCustomer').on('click', function () {
        ...
        firebase.database().ref('components/' + userID).set({
            name: name,
            price: price,
        });
    ...
    $('body').on('click', '.updateData', function () {
        ...
        firebase.database().ref('components/' + updateID).on('value', function (snapshot) {
    ...
    $('.updateCustomer').on('click', function () {
        ...
        var updates = {};
        updates['/components/' + updateID] = postData;
    ...
    $('.deleteRecord').on('click', function () {
        ...
        firebase.database().ref('components/' + id).remove();
